...
#endif
{
  ...
  */
  ...
  virtual std::shared_ptr<Cell> GetNext() const {return m_next;}
   ...
   */
  virtual std::shared_ptr<Cell> GetNextToDraw() const {return m_nextToDraw;}
   ...
   */
  std::shared_ptr<Cell> m_previous;
